  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/*
        ...
        - Dynamic horizontal padding for mobile/tablet/desktop.
        - Tighter vertical spacing on mobile (space-y-8) vs desktop (space-y-12).
      */}
      <div className="relative z-10 mx-auto max-w-7xl space-y-8 md:space-y-12 px-4 sm:px-6 lg:px-8 pt-4 md:pt-6 pb-20">
        ...
        {/*
          Bottom Grid: 
          Stacked by default, but maintains a consistent gap for readability.
        */}
